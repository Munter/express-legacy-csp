...
module.exports = function preprocessCaniuseData(stats) {
    ...
    const rangesAndIsSupportedByCaniuseId = {};
    Object.keys(stats).forEach(caniuseId => {
        ...
        Object.keys(stats[caniuseId]).forEach(version => {
            ...
            if (version === 'all') {
                (rangesAndIsSupportedByCaniuseId[caniuseId] = rangesAndIsSupportedByCaniuseId[caniuseId] || []).push(() => isSupported);
                ...
                range._isSupported = isSupported;
                (rangesAndIsSupportedByCaniuseId[caniuseId] = rangesAndIsSupportedByCaniuseId[caniuseId] || []).push((major, minor, patch) => {
    ...
    return function checkSupported(caniuseId, major, minor, patch) {
        ...
        const ranges = rangesAndIsSupportedByCaniuseId[caniuseId];
        if (ranges) {
